...
//           className="flex items-center mb-6 w-full max-w-md bg-gray-800 rounded-full shadow-md py-2 px-4 sticky top-0 z-10"
//         >
...
//           className="bg-gray-800 p-4 rounded-lg shadow-md sticky bottom-0 z-10 border-t border-gray-700"
//         >
